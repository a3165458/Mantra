...
mantrachaind tx staking delegate $(mantrachaind keys show $wallet_name --bech val -a)  ${math}om --from $wallet_name --gas=500000 --gas-prices=99999amantrachain -y --node $MANTRACHAIN_RPC_PORT
